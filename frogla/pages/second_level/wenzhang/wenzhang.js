...
Page({
  ...
  onLoad:function(){
    ...
    wx.request({
      ...
      success: function (res) {
         // Modify the response data to include the content of each article
         res.data.forEach(function(article) {
          article.content = 'This is the content of the article.' // Replace with actual content
        })
        // Store the response data in the messages property of the data object
        that.setData({
          list: res.data,
  ...
  // Function to display the content of an article
  showContent: function(content) {
    // Display the content in a new page or modal dialog
  }
